...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        <audio controls>
          <source src="./audio/techmo.mp3" type="audio/mpeg">
          El navenador no soporta ese formato
        </audio>
      </div>
      <div class="col-sm-6">
        <button type="button" class="btn btn-warning" onclick="llamada()">
          Boton
        </button>
      </div>
    </div>
...
<script>
  function llamada() {
    alert('Lenguaje de lado de cliente');
    var nombre = document.getElementById('nombre');
    var edad = document.getElementById('edad');
    nombre.value = 'Un nombre x';
    edad.value = 100;
  }
</script>